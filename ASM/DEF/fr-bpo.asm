...
;dd 0A4h,0048h,2;dd 0B4h ; H -> ₴
;dd 0A4h,0068h,2;dd 0B4h ; h -> ₴
;dd 0A4h,0049h,17dbh ; I -> ៛
;dd 0A4h,0069h,fdfch ; i -> ﷼
...
;dd 2Fh,0032h,01bbh ; 2 -> ƻ
;dd 2Fh,003dh,2260h ; = -> ≠
;dd 2Fh,0041h,023ah ; A -> Ⱥ
;dd 2Fh,0061h,2c65h ; a -> ⱥ
;dd 2Fh,0042h,0243h ; B -> Ƀ
;dd 2Fh,0062h,0180h ; b -> ƀ
;dd 2Fh,0043h,023bh ; C -> Ȼ
;dd 2Fh,0063h,023ch ; c -> ȼ
;dd 2Fh,0044h,0110h ; D -> Đ
;dd 2Fh,0064h,0111h ; d -> đ
;dd 2Fh,0045h,0246h ; E -> Ɇ
;dd 2Fh,0065h,0247h ; e -> ɇ
;dd 2Fh,0047h,01e4h ; G -> Ǥ
;dd 2Fh,0067h,01e5h ; g -> ǥ
;dd 2Fh,003eh,226fh ; > -> ≯
;dd 2Fh,2265h,2271h ; ≥ -> ≱
;dd 2Fh,0048h,0126h ; H -> Ħ
;dd 2Fh,0068h,0127h ; h -> ħ
;dd 2Fh,0049h,0197h ; I -> Ɨ
;dd 2Fh,0069h,0268h ; i -> ɨ
;dd 2Fh,004ah,0248h ; J -> Ɉ
;dd 2Fh,006ah,0249h ; j -> ɉ
;dd 2Fh,0269h,1d7ch ; ɩ -> ᵼ
;dd 2Fh,0237h,025fh ; ȷ -> ɟ
;dd 2Fh,004ch,0141h ; L -> Ł
;dd 2Fh,006ch,0142h ; l -> ł
;dd 2Fh,003ch,226eh ; < -> ≮
;dd 2Fh,2264h,2270h ; ≤ -> ≰
;dd 2Fh,00d3h,01feh ; Ó -> Ǿ
;dd 2Fh,004fh,00d8h ; O -> Ø
;dd 2Fh,00f3h,01ffh ; ó -> ǿ
;dd 2Fh,006fh,00f8h ; o -> ø
;dd 2Fh,0050h,2c63h ; P -> Ᵽ
;dd 2Fh,0070h,1d7dh ; p -> ᵽ
;dd 2Fh,0052h,024ch ; R -> Ɍ
;dd 2Fh,0072h,024dh ; r -> ɍ
;dd 2Fh,0054h,0166h ; T -> Ŧ
;dd 2Fh,0074h,0167h ; t -> ŧ
;dd 2Fh,0055h,0244h ; U -> Ʉ
;dd 2Fh,0075h,0289h ; u -> ʉ
;dd 2Fh,0059h,024eh ; Y -> Ɏ
;dd 2Fh,0079h,024fh ; y -> ɏ
dd 2Fh,005ah,01b5h ; Z -> Ƶ
dd 2Fh,007ah,01b6h ; z -> ƶ
;dd 2Fh,2Fh,2Fh ; / -> /
;dd 2Fh,0a0h,338h ;   -> ̸
;dd 2Fh,20h,2Fh ;   -> /

...
#compilation des fichiers de dÃ©finitions
...
#ajout de la bibliotheque de base pour la crÃ©ation d'application assembleur et d'un exemple a l'archive du noyau
...
#ajout des applications et de leurs donnÃ©es de base Ã  l'archive du noyau
